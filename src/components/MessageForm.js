...
export default function MessageForm() {
	...
	return (
		<Form>
			...
			<HeaderForm>
				{message.type === "Error" ? (
					<FormButton clicked>Error</FormButton>
				) : (
					<FormButton onClick={() => handleChangeType("Error")}>
						Error
					</FormButton>
				)}
				{message.type === "Suggestion" ? (
					<FormButton clicked>Suggestion</FormButton>
				) : (
					<FormButton onClick={() => handleChangeType("Suggestion")}>
						Suggestion
					</FormButton>
				)}
			</HeaderForm>
